...
class LERFDataManager(VanillaDataManager):  # pylint: disable=abstract-method
    ...
    def __init__(
        ...
        **kwargs,  # pylint: disable=unused-argument
        ...
        # Mod1: mask paths
        sam_cache_path = Path(osp.join(cache_dir, "sam"))
        ...
        # Mod1: init mask dataloader and create masks
        self.sam_dataloader = SAMDataloader(
            cfg={
                "sam_ckpt_path": ("/cluster/51/kzhou/sam_weights/sam_vit_h_4b8939.pth"),# abs path to model 
        ...
        self.clip_interpolator = PyramidEmbeddingDataloader(
            ...
            sam_loader=  self.sam_dataloader # Mod1: pass dataloader to pyramid
